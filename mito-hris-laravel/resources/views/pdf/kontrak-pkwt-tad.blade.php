...
@php
    ...
    $damarindoAddr = 'Ruko Sastra Plasa Blok A No. 06 Jalan Raya Gatot Subroto KM 5,4, Jatiuwung Kota Tangerang';
@endphp

{{-- ═══════════════════════════════════════════════════════════════
     SECTION 1 — Halaman Judul & Para Pihak & Konsideran
     Berakhir dengan footer paraf + page-break
═══════════════════════════════════════════════════════════════ --}}
<div class="page-section">
    ...
    <ol class="pasal-list">
        ...
        <li>Surat Izin Usaha Perusahan Penyedia Jasa Pekerja/Buruh Nomor : 9120202811565/78200 Tanggal 16 Agustus 2020.</li>
    </ol>
    ...
    <ol class="pasal-list">
        <li>PIHAK PERTAMA adalah perseroan terbatas yang bergerak dalam bidang penempatan dan pengelolaan sumber daya
            manusia yang jenis pekerjaannya didasarkan kepada job order perusahaan pengguna jasa dengan waktu tertentu.</li>
        ...
        <li>Perusahaan pengguna jasa adalah perusahaan yang membutuhkan tenaga kerja dari PIHAK PERTAMA untuk
            dipekerjakan pada perusahaan pengguna jasa sesuai dengan keahlian dan order yang diterima oleh PIHAK PERTAMA.</li>
    </ol>
...
<div class="page-section">
    ...
    <ol class="pasal-list">
        <li>Kesepakatan pengikatan kerja waktu tertentu adalah untuk tenaga alihdaya adalah tenaga kerja yang telah
            mengerti dan setuju untuk ditempatkan oleh PIHAK PERTAMA dengan batasan waktu kerja yang telah ditentukan.</li>
    ...
    <ol class="pasal-list">
        ...
        <li>Penempatan PIHAK KEDUA oleh PIHAK PERTAMA setelah dilakukan pengikatan kesepakatan kerja sama secara
            tertulis antara PIHAK PERTAMA dengan perusahaan yang menggunakan tenaga kerja (perusahaan pengguna jasa).</li>
        <li>PIHAK KEDUA dinyatakan telah mengerti, paham dan setuju untuk ditempatkan oleh PIHAK PERTAMA dan akan
            selalu taat dengan peraturan dari PIHAK PERTAMA.</li>
...
<div class="page-section">
    ...
    <ol class="pasal-list">
        <li>PIHAK PERTAMA berkewajiban membayar upah setiap bulan 1 (satu) kali, setiap 2 (dua) minggu atau setiap
            minggu 1 (satu) kali ataupun dengan ketentuan yang berlaku di perusahaan pemakai jasa kepada PIHAK KEDUA,
            tanpa dapat diwakilkan, kecuali PIHAK KEDUA berhalangan hadir dapat diwakilkan oleh orang lain. Ketentuan
    ...
    <ol class="pasal-list">
        ...
        <li>PIHAK KEDUA berkewajiban taat serta patuh terhadap waktu kerja dan peraturan di perusahaan pengguna jasa.</li>
        ...
        <li>PIHAK KEDUA berhak Mendapatkan Tunjangan Hari Raya sesuai masa kerja (Proret).</li>
        <li>PIHAK KEDUA berhak memperoleh upah yang besarnya disesuaikan dengan sistem kerja di perusahaan pengguna jasa.</li>
        <li>PIHAK KEDUA berkewajiban menjaga nama baik perusahaan pengguna jasa dan PIHAK PERTAMA dimata umum /
            masyarakat.</li>
        <li>PIHAK KEDUA mendapatkan fasilitas kesehatan, apabila ada kartu kesehatan yang disepakati oleh PIHAK
            pengguna jasa dengan PIHAK PERTAMA apabila terjadi kecelakaan kerja pada saat melaksanakan pekerjaan dan
            dapat berobat ke Poliklinik atau Rumah Sakit yang ditunjuk oleh PIHAK PERTAMA atau pihak perusahaan
            pengguna jasa.</li>
...
<div class="page-section">
    ...
    <ol class="pasal-list">
        <li>KEDUA BELAH PIHAK sepakat apabila PIHAK KEDUA tidak melaksanakan tugas, tanggung jawab dan kewajibannya
            ...
            <ol class="pasal-list alpha">
                <li>Memberikan teguran baik secara lisan maupun tulisan kepada PIHAK KEDUA, dan apabila tidak
                    diindahkan, maka akan dilakukan tindakan berupa pemutusan hubungan kerja.</li>
                <li>PIHAK PERTAMA berhak untuk memantau dan mengevaluasi pelaksanaan pekerjaan yang dilaksanakan PIHAK
                    KEDUA.</li>
            </ol>
        </li>
        <li>PIHAK KEDUA harus tunduk dan melaksanakan segala peraturan yang berlaku, tindakan yang menyimpang
            dinyatakan sebagai pelanggaran dan bersedia menerima sanksi apapun dari PIHAK PERTAMA.</li>
    ...
    <ol class="pasal-list">
        ...
        <li>PIHAK KEDUA dalam keadaan dan alasan apapun tidak diperkenankan atau diperbolehkan untuk memberitahukan
            ...
            PIHAK KETIGA manapun juga, kecuali atas permintaan dari instansi yang terkait / berwenang dengan
            persetujuan tertulis terlebih dahulu dari PIHAK PERTAMA.</li>
    ...
    <ol class="pasal-list">
        <li>KEDUA BELAH PIHAK sepakat membebaskan masing-masing bila terjadi hal-hal diluar kekuasaan manusia /
            force majeur.</li>
...
{{-- ═══════════════════════════════════════════════════════════════
     SECTION 5 — Pasal 10–11 + Tanda Tangan (tanpa footer paraf)
═══════════════════════════════════════════════════════════════ --}}
<div class="page-section-last">

    <div class="pasal-heading">Pasal 10<br>Pengakhiran Perjanjian</div>

    <ol class="pasal-list">
        <li>Perjanjian ini akan berakhir dengan sendirinya apabila memenuhi Pasal 3, Pasal 5 ayat 2, ayat 4, ayat 5,
            ayat 7, ayat 9, dan pasal 7 dalam perjanjian ini.</li>
        ...
        <li>Dalam hal terjadi pengakhiran atau pembatalan perjanjian, maka KEDUA BELAH PIHAK sepakat untuk tidak
            memberlakukan ketentuan yang terdapat dalam pasal 1266 dan 1267 Kitab Undang-Undang Hukum Perdata atau
            tidak ada kewajiban dari PIHAK PERTAMA untuk memberikan uang ganti rugi, pesangon dan / atau uang
            kebijaksanaan dalam bentuk apapun kepada PIHAK KEDUA.</li>
        <li>PIHAK PERTAMA berhak setiap waktu mengakhiri kesepakatan kerja waktu tertentu ini karena adanya alasan
            ...
            kesalahan / pelanggaran lainnya yang merugikan PIHAK PERTAMA ataupun pihak pengguna jasa, dan / atau
            dianggap tidak cakap / tidak mampu dalam melaksanakan pekerjaan yang dibebankan kepada PIHAK KEDUA.</li>
        <li>Segala sesuatu yang belum diatur dalam perjanjian ini akan diatur dalam perjanjian tersendiri
            (addendum / Amandemen) yang merupakan bagian yang menyatu dan tidak terpisahkan dengan perjanjian ini.</li>
    </ol>

    <div class="pasal-heading">Pasal 11<br>Penutup</div>

    <p>Perjanjian ini dibuat dan ditandatangani oleh KEDUA BELAH PIHAK pada hari, tanggal, bulan dan tahun
        sebagaimana tersebut diatas, dibuat dalam kertas bermaterai secukupnya yang sifatnya mengikat serta mempunyai
        kekuatan hukum dan tanpa paksaan / tekanan dari siapapun.</p>
...
<div class="page-section">
    ...
    <ol class="pasal-list">
        ...
        <li>Bahwa saya menyatakan dengan sebenar-benarnya bahwa selama menjalankan tugas dan bekerja pada perusahaan
            ...
            mengganggu hubungan kerja atau kepentingan perusahaan, tanpa mengikuti ketentuan dan prosedur yang berlaku.</li>
        ...
        <li>Bahwa apabila saya mengingkari pernyataan ini yang merupakan persyaratan untuk dapat saya bekerja, maka
            saya bersedia untuk dituntut sesuai dengan ketentuan hukum yang berlaku.</li>
    </ol>

    <p>Demikianlah surat pernyataan ini saya tanda tangani di Tangerang, pada tanggal
        <strong>{{ $docDateFmt }}</strong> dalam keadaan sadar, sehat jasmani dan rohani serta tanpa adanya unsur
        paksaan atau tekanan dari pihak manapun juga.</p>
