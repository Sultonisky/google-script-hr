...
<body>
    ...
    <table class="data-table">
        <tr>
            ...
            <td class="colon">:</td>
            <td class="value">Bahwa Perusahaan perlu menetapkan keputusan atas pengunduran diri karyawan sesuai dengan
    ...
    <table class="data-table">
        <tr>
            ...
            <td class="colon">:</td>
            <td class="value">Menerima pengunduran diri <strong>{{ $employee->fullName }}</strong>, efektif per
                <strong>{{ $resignFmt }}</strong>.</td>
        </tr>
        <tr>
            <td class="label">Kedua</td>
            <td class="colon">:</td>
            <td class="value">Menyampaikan apresiasi dan terima kasih atas kontribusi yang telah diberikan selama
                bekerja di <strong>{{ $companyName }}</strong>.</td>
        </tr>
        <tr>
            <td class="label">Ketiga</td>
            <td class="colon">:</td>
            <td class="value">Menerangkan bahwa <strong>{{ $employee->fullName }}</strong> telah bekerja di
                <strong>{{ $companyName }}</strong> sebagai <strong>{{ $statusLabel }}</strong>, terhitung mulai
                <strong>{{ $joinFmt }}</strong> dengan jabatan terakhir sebagai
                <strong>{{ $jobPosition }}</strong>.</td>
        </tr>
    </table>
