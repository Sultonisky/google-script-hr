...
if (!app()->environment('local')) {
    ...
    Route::domain(config('hris.domains.assets'))->middleware('web')->group(function () {
        assetPortalRoutes();
    });
    Route::domain(config('hris.domains.certificates'))->middleware('web')->group(function () {
        certificatePortalRoutes();
    });
} // end !local
