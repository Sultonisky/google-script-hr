...
@section('content')
<!-- LOADING OVERLAY -->
<div class="loading-overlay" id="loadingOverlay" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9999;display:none;flex-direction:column;align-items:center;justify-content:center;gap:16px;">
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-7 col-md-8">
        ...
        <p class="hero-subtitle">Silakan lengkapi formulir pendaftaran berikut dengan data yang benar dan lengkap. Seluruh data akan digunakan hanya untuk kebutuhan proses rekrutmen.</p>
      </div>
...
<div class="content-wrap py-4">
  <div class="container" style="max-width:960px;">
      ...
      <form action="{{ route('public.career.store') }}" method="POST" id="formPendaftaran" novalidate>
            ...
            <div class="row g-3">
              <div class="col-12">
                ...
                <div class="p-2 rounded mt-2 d-flex align-items-center gap-2" style="background:#f0f7ff;border:1px solid #c7dff7;font-size:12px;color:#005BAC">
                  ...
                  <div>Sistem akan mengisi beberapa informasi secara otomatis berdasarkan struktur NIK. Pastikan seluruh data yang ditampilkan sudah sesuai sebelum mengirim lamaran.</div>
                </div>
              ...
              <div class="col-md-6">
                <label class="form-label fw-semibold" for="age" style="font-size:13px">Usia <span class="text-danger">*</span></label>
                <input type="number" class="form-control" id="age" name="usia" value="{{ old('usia') }}" required min="17" max="100" readonly style="background-color:#f8f9fa;cursor:default;" placeholder="Otomatis dari Tanggal Lahir">
        ...
        <div class="form-section" id="sectionContact">
          <div class="form-section-header">
            ...
            <div><h5>Informasi Kontak</h5><p>Data komunikasi dan alamat Anda</p></div>
            <span class="section-status" id="secBadgeContact"><i class="bi bi-hourglass-split"></i> Belum lengkap</span>
          </div>
          <div class="form-section-body p-4">
            <div class="row g-3">
              <div class="col-md-6">
                <label class="form-label fw-semibold" for="email" style="font-size:13px">Alamat Email <span class="text-danger">*</span></label>
              ...
              <div class="col-12">
                <label class="form-label fw-semibold" for="address" style="font-size:13px">Detail Alamat <span class="text-danger">*</span></label>
                <textarea class="form-control" id="address" name="alamat_domisili" rows="3" required placeholder="Nama jalan, nomor rumah, RT/RW, dll.">{{ old('alamat_domisili') }}</textarea>
        ...
        <div class="form-section" id="sectionEmployment">
          <div class="form-section-header">
            ...
            <div><h5>Informasi Pekerjaan</h5><p>Pengalaman dan ekspektasi karir Anda</p></div>
          ...
          <div class="form-section-body p-4">
            <div class="row g-3">
              ...
              <div class="col-md-6">
                <label class="form-label fw-semibold" for="education" style="font-size:13px">Pendidikan Terakhir <span class="text-danger">*</span></label>
              ...
              <div class="col-md-6">
                <label class="form-label fw-semibold" for="work_experience" style="font-size:13px">Pengalaman Kerja <span class="text-danger">*</span></label>
              ...
              <div class="col-md-6" id="lastCompanyGroup" style="display:none;">
                <label class="form-label fw-semibold" for="last_company" style="font-size:13px">Perusahaan Terakhir</label>
                <input type="text" class="form-control" id="last_company" name="perusahaan_terakhir" value="{{ old('perusahaan_terakhir') }}" autocomplete="organization" disabled>
                <div class="invalid-feedback">Nama perusahaan wajib diisi.</div>
              </div>

              <div class="col-md-6">
                <label class="form-label fw-semibold" for="current_employment_status" style="font-size:13px">Status Bekerja Saat Ini <span class="text-danger">*</span></label>
                <select class="form-select" id="current_employment_status" name="status_bekerja" required>
              ...
              <div class="col-md-6">
                <label class="form-label fw-semibold" for="available_to_join" style="font-size:13px">Kesediaan Bergabung <span class="text-danger">*</span></label>
                <select class="form-select" id="available_to_join" name="kesediaan_bergabung" required>
              ...
              <div class="col-md-6">
                <label class="form-label fw-semibold" for="expected_salary" style="font-size:13px">Ekspektasi Gaji <span class="text-danger">*</span></label>
                <div class="input-group-prefix d-flex">
                  <span class="input-prefix d-flex align-items-center px-3 border border-end-0 rounded-start bg-light text-muted" style="font-size:13px;">Rp</span>
                  <input type="text" class="form-control rounded-start-0" id="expected_salary" name="ekspektasi_gaji" value="{{ old('ekspektasi_gaji') }}" required inputmode="numeric" placeholder="10.000.000">
                </div>
                <div class="invalid-feedback">Ekspektasi gaji wajib diisi dengan angka.</div>
              </div>

              <div class="col-md-6">
                <label class="form-label fw-semibold" for="recruitment_source" style="font-size:13px">Sumber Informasi Lowongan <span class="text-danger">*</span></label>
          ...
          <div class="card-body p-4">
            <div class="form-check mb-3">
              ...
              <label class="form-check-label ms-2 fw-semibold" for="agreement" style="font-size:13px;cursor:pointer;color:#0B2540;">
                Saya menyatakan bahwa seluruh data yang saya isi adalah benar dan dapat dipertanggungjawabkan. Saya bersedia mengikuti seluruh proses rekrutmen MITO Group apabila memenuhi kualifikasi.
              </label>
            </div>
    ...
    <div id="successPage" style="display:none;text-align:center;padding:80px 20px;">
      ...
      <h2 class="success-title" style="font-size:30px;font-weight:800;color:#1f2937;margin-bottom:16px;">Pendaftaran Berhasil</h2>
...
var REGIONS = {
  ...
  "cities": {
    "1101":"KAB. ACEH SELATAN","1102":"KAB. ACEH TENGGARA","1103":"KAB. ACEH TIMUR","1104":"KAB. ACEH TENGAH","1105":"KAB. ACEH BARAT","1106":"KAB. ACEH BESAR","1107":"KAB. PIDIE","1108":"KAB. ACEH UTARA","1109":"KAB. SIMEULUE","1110":"KAB. ACEH SINGKIL","1111":"KAB. BIREUEN","1112":"KAB. ACEH BARAT DAYA","1113":"KAB. GAYO LUES","1114":"KAB. ACEH JAYA","1115":"KAB. NAGAN RAYA","1116":"KAB. ACEH TAMIANG","1117":"KAB. BENER MERIAH","1118":"KAB. PIDIE JAYA","1171":"KOTA BANDA ACEH","1172":"KOTA SABANG","1173":"KOTA LHOKSEUMAWE","1174":"KOTA LANGSA","1175":"KOTA SUBULUSSALAM",
    "1201":"KAB. TAPANULI TENGAH","1202":"KAB. TAPANULI UTARA","1203":"KAB. TAPANULI SELATAN","1204":"KAB. NIAS","1205":"KAB. LANGKAT","1206":"KAB. KARO","1207":"KAB. DELI SERDANG","1208":"KAB. SIMALUNGUN","1209":"KAB. ASAHAN","1210":"KAB. LABUHANBATU","1211":"KAB. DAIRI","1212":"KAB. TOBA","1213":"KAB. MANDAILING NATAL","1214":"KAB. NIAS SELATAN","1215":"KAB. PAKPAK BHARAT","1216":"KAB. HUMBANG HASUNDUTAN","1217":"KAB. SAMOSIR","1218":"KAB. SERDANG BEDAGAI","1219":"KAB. BATU BARA","1220":"KAB. PADANG LAWAS UTARA","1221":"KAB. PADANG LAWAS","1222":"KAB. LABUHANBATU SELATAN","1223":"KAB. LABUHANBATU UTARA","1224":"KAB. NIAS UTARA","1225":"KAB. NIAS BARAT","1271":"KOTA MEDAN","1272":"KOTA PEMATANG SIANTAR","1273":"KOTA SIBOLGA","1274":"KOTA TANJUNG BALAI","1275":"KOTA BINJAI","1276":"KOTA TEBING TINGGI","1277":"KOTA PADANG SIDEMPUAN","1278":"KOTA GUNUNGSITOLI",
    "1301":"KAB. PESISIR SELATAN","1302":"KAB. SOLOK","1303":"KAB. SIJUNJUNG","1304":"KAB. TANAH DATAR","1305":"KAB. PADANG PARIAMAN","1306":"KAB. AGAM","1307":"KAB. LIMA PULUH KOTA","1308":"KAB. PASAMAN","1309":"KAB. KEP. MENTAWAI","1310":"KAB. DHARMASRAYA","1311":"KAB. SOLOK SELATAN","1312":"KAB. PASAMAN BARAT","1371":"KOTA PADANG","1372":"KOTA SOLOK","1373":"KOTA SAWAHLUNTO","1374":"KOTA PADANG PANJANG","1375":"KOTA BUKITTINGGI","1376":"KOTA PAYAKUMBUH","1377":"KOTA PARIAMAN",
    "1401":"KAB. KAMPAR","1402":"KAB. INDRAGIRI HULU","1403":"KAB. BENGKALIS","1404":"KAB. INDRAGIRI HILIR","1405":"KAB. PELALAWAN","1406":"KAB. ROKAN HULU","1407":"KAB. ROKAN HILIR","1408":"KAB. SIAK","1409":"KAB. KUANTAN SINGINGI","1410":"KAB. KEP. MERANTI","1471":"KOTA PEKANBARU","1472":"KOTA DUMAI",
    "1501":"KAB. KERINCI","1502":"KAB. MERANGIN","1503":"KAB. SAROLANGUN","1504":"KAB. BATANGHARI","1505":"KAB. MUARO JAMBI","1506":"KAB. TANJUNG JABUNG BARAT","1507":"KAB. TANJUNG JABUNG TIMUR","1508":"KAB. BUNGO","1509":"KAB. TEBO","1571":"KOTA JAMBI","1572":"KOTA SUNGAI PENUH",
    "1601":"KAB. OGAN KOMERING ULU","1602":"KAB. OGAN KOMERING ILIR","1603":"KAB. MUARA ENIM","1604":"KAB. LAHAT","1605":"KAB. MUSI RAWAS","1606":"KAB. MUSI BANYUASIN","1607":"KAB. BANYUASIN","1608":"KAB. OGAN KOMERING ULU TIMUR","1609":"KAB. OGAN KOMERING ULU SELATAN","1610":"KAB. OGAN ILIR","1611":"KAB. EMPAT LAWANG","1612":"KAB. PENUKAL ABAB LEMATANG ILIR","1613":"KAB. MUSI RAWAS UTARA","1671":"KOTA PALEMBANG","1672":"KOTA PAGAR ALAM","1673":"KOTA LUBUKLINGGAU","1674":"KOTA PRABUMULIH",
    "1701":"KAB. BENGKULU SELATAN","1702":"KAB. REJANG LEBONG","1703":"KAB. BENGKULU UTARA","1704":"KAB. KAUR","1705":"KAB. SELUMA","1706":"KAB. MUKOMUKO","1707":"KAB. LEBONG","1708":"KAB. KEPAHIANG","1709":"KAB. BENGKULU TENGAH","1771":"KOTA BENGKULU",
    ...
    "1901":"KAB. BANGKA","1902":"KAB. BELITUNG","1903":"KAB. BANGKA SELATAN","1904":"KAB. BANGKA TENGAH","1905":"KAB. BANGKA BARAT","1906":"KAB. BELITUNG TIMUR","1971":"KOTA PANGKAL PINANG",
    "2101":"KAB. BINTAN","2102":"KAB. KARIMUN","2103":"KAB. NATUNA","2104":"KAB. LINGGA","2105":"KAB. KEP. ANAMBAS","2171":"KOTA BATAM","2172":"KOTA TANJUNG PINANG",
    ...
    "5201":"KAB. LOMBOK BARAT","5202":"KAB. LOMBOK TENGAH","5203":"KAB. LOMBOK TIMUR","5204":"KAB. SUMBAWA","5205":"KAB. DOMPU","5206":"KAB. BIMA","5207":"KAB. SUMBAWA BARAT","5208":"KAB. LOMBOK UTARA","5271":"KOTA MATARAM","5272":"KOTA BIMA",
    "6101":"KAB. SAMBAS","6102":"KAB. MEMPAWAH","6103":"KAB. SANGGAU","6104":"KAB. KETAPANG","6105":"KAB. SINTANG","6106":"KAB. KAPUAS HULU","6107":"KAB. BENGKAYANG","6108":"KAB. LANDAK","6109":"KAB. SEKADAU","6110":"KAB. MELAWI","6111":"KAB. KAYONG UTARA","6112":"KAB. KUBU RAYA","6171":"KOTA PONTIANAK","6172":"KOTA SINGKAWANG",
    "6401":"KAB. PASER","6402":"KAB. KUTAI KARTANEGARA","6403":"KAB. BERAU","6404":"KAB. KUTAI BARAT","6405":"KAB. KUTAI TIMUR","6406":"KAB. PENAJAM PASER UTARA","6407":"KAB. MAHAKAM ULU","6471":"KOTA BALIKPAPAN","6472":"KOTA SAMARINDA","6473":"KOTA BONTANG",
    "7101":"KAB. BOLAANG MONGONDOW","7102":"KAB. MINAHASA","7103":"KAB. KEP. SANGIHE","7104":"KAB. KEP. TALAUD","7105":"KAB. MINAHASA SELATAN","7106":"KAB. MINAHASA UTARA","7107":"KAB. MINAHASA TENGGARA","7108":"KAB. BOLAANG MONGONDOW UTARA","7171":"KOTA MANADO","7172":"KOTA BITUNG","7173":"KOTA TOMOHON","7174":"KOTA KOTAMOBAGU",
    "7201":"KAB. BANGGAI","7202":"KAB. POSO","7203":"KAB. DONGGALA","7204":"KAB. TOLI TOLI","7205":"KAB. BUOL","7206":"KAB. MOROWALI","7207":"KAB. BANGGAI KEPULAUAN","7208":"KAB. PARIGI MOUTONG","7209":"KAB. TOJO UNA UNA","7210":"KAB. SIGI","7271":"KOTA PALU",
    "7301":"KAB. KEP. SELAYAR","7302":"KAB. BANTAENG","7303":"KAB. JENEPONTO","7304":"KAB. TAKALAR","7305":"KAB. GOWA","7306":"KAB. SINJAI","7307":"KAB. BONE","7308":"KAB. MAROS","7309":"KAB. PANGKAJENE KEP.","7310":"KAB. BARRU","7311":"KAB. SOPPENG","7312":"KAB. WAJO","7313":"KAB. SIDENRENG RAPPANG","7314":"KAB. PINRANG","7315":"KAB. ENREKANG","7316":"KAB. LUWU","7317":"KAB. TANA TORAJA","7318":"KAB. LUWU UTARA","7319":"KAB. LUWU TIMUR","7320":"KAB. TORAJA UTARA","7371":"KOTA MAKASSAR","7372":"KOTA PARE PARE","7373":"KOTA PALOPO",
    "7401":"KAB. KOLAKA","7402":"KAB. KONAWE","7403":"KAB. MUNA","7404":"KAB. BUTON","7405":"KAB. KONAWE SELATAN","7406":"KAB. BOMBANA","7407":"KAB. WAKATOBI","7408":"KAB. KOLAKA UTARA","7409":"KAB. KONAWE UTARA","7471":"KOTA KENDARI","7472":"KOTA BAU BAU",
    "7501":"KAB. GORONTALO","7502":"KAB. BOALEMO","7503":"KAB. BONE BOLANGO","7504":"KAB. PAHUWATO","7505":"KAB. GORONTALO UTARA","7571":"KOTA GORONTALO",
    "7601":"KAB. MAJENE","7602":"KAB. POLEWALI MANDAR","7603":"KAB. MAMASA","7604":"KAB. MAMUJU","7605":"KAB. MAMUJU TENGAH","7606":"KAB. MAMUJU UTARA",
    "8101":"KAB. MALUKU TENGGARA BARAT","8102":"KAB. MALUKU TENGGARA","8103":"KAB. MALUKU TENGAH","8104":"KAB. BURU","8105":"KAB. KEP. ARU","8106":"KAB. SERAM BAGIAN BARAT","8107":"KAB. SERAM BAGIAN TIMUR","8108":"KAB. MALUKU BARAT DAYA","8109":"KAB. BURU SELATAN","8171":"KOTA AMBON","8172":"KOTA TUAL",
    "8201":"KAB. HALMAHERA BARAT","8202":"KAB. HALMAHERA TENGAH","8203":"KAB. HALMAHERA UTARA","8204":"KAB. HALMAHERA SELATAN","8205":"KAB. KEP. SULA","8206":"KAB. HALMAHERA TIMUR","8207":"KAB. PULAU MOROTAI","8271":"KOTA TERNATE","8272":"KOTA TIDORE KEPULAUAN",
...
function showAlreadySubmittedPage() {
  ...
  if (sp) {
    ...
    if (msg) msg.innerHTML = 'Anda telah mengirimkan lamaran pada sesi ini.<br><br>Apabila Anda merasa ini adalah kesalahan, silakan hubungi tim Human Resources MITO Group.';
  }
}
...
// ============================================================
var FORM_SECTIONS = [
  { id:'sectionPersonal',   badgeId:'secBadgePersonal',   fields:['nik','full_name','birth_date','age','gender','marital_status'] },
  { id:'sectionContact',    badgeId:'secBadgeContact',    fields:['email','phone','province','city','address'], district:true },
  { id:'sectionEmployment', badgeId:'secBadgeEmployment', fields:['position_applied','education','work_experience','current_employment_status','available_to_join','expected_salary','recruitment_source'], lastCompany:true },
];
...
function parseNIK(nik) {
  ...
  var day = parseInt(rawDay, 10), gender = (day > 40) ? 'Perempuan' : 'Laki-laki';
  if (day > 40) day -= 40;
...
function showNIKFeedback(success, r) {
  ...
  if (success) {
    ...
    nikFeedback.innerHTML = '<div class="alert alert-success p-2 mb-0" style="font-size:12px"><i class="bi bi-check-circle-fill me-1"></i> <strong>Data berhasil dikenali</strong><ul class="mb-0 mt-1 ps-3">' + det.map(function(d) { return '<li>' + d + '</li>'; }).join('') + '</ul></div>';
  } else {
    nikFeedback.innerHTML = '<div class="alert alert-warning p-2 mb-0" style="font-size:12px"><i class="bi bi-exclamation-triangle-fill me-1"></i> <strong>NIK tidak valid.</strong> Pastikan nomor KTP terdiri dari 16 digit yang benar.</div>';
  }
}
...
function initForm() {
  ...
  emailInput.addEventListener('input', function() { emailValidation.style.display = 'none'; validateField(this); updateProgress(); });
  ...
  workExpSelect.addEventListener('change', function() {
    ...
    if (this.value === '' || this.value === 'Fresh Graduate') {
      lastCompanyGroup.style.display = 'none'; lc.value = ''; lc.disabled = true; lc.required = false;
      lc.classList.remove('is-valid', 'is-invalid');
    } else {
      lastCompanyGroup.style.display = 'block'; lc.disabled = false; lc.required = true;
    }
    validateField(this); updateProgress();
  });
  ...
  form.addEventListener('submit', function(e) {
    ...
    if (!form.checkValidity() || !validateBirthDate()) {
      ...
      if (!validateBirthDate()) birthDateInput.scrollIntoView({ behavior: 'smooth', block: 'center' });
      return;
    }
