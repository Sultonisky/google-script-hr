...
<head>
    ...
    <title>Login — Portal Sertifikasi | {{ config('app.name', 'MITO HRIS') }}</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        #certLoginPassword { padding-right: 42px; }
...
<div class="login-page">
    ...
    <div class="login-card">
        ...
        <div class="login-card-title">Portal Sertifikasi</div>
        <div class="login-card-subtitle">Masuk untuk mengelola sertifikasi karyawan</div>
        ...
        <form id="loginForm" method="POST" action="{{ route('certificates.login.post') }}" autocomplete="on" novalidate>
            @csrf
            <div class="login-form-group">
                <label for="certLoginIdentifier">Email atau Username</label>
                <div class="input-wrapper">
                    <i class="bi bi-person-fill"></i>
                    <input type="text" id="certLoginIdentifier" name="identifier"
                           placeholder="Email atau Username" autocomplete="username" required autofocus />
                </div>
            </div>
            <div class="login-form-group">
                <label for="certLoginPassword">Password</label>
                <div class="input-wrapper">
                    <i class="bi bi-lock-fill"></i>
                    <input type="password" id="certLoginPassword" name="password"
    ...
    <div class="login-features">
        <div class="feature-chip"><i class="bi bi-patch-check-fill"></i> Manajemen Sertifikasi</div>
        <div class="feature-chip"><i class="bi bi-person-badge-fill"></i> Akses Berbasis Role</div>
        <div class="feature-chip"><i class="bi bi-calendar-check-fill"></i> Monitoring Expiry</div>
        <div class="feature-chip"><i class="bi bi-file-earmark-pdf-fill"></i> Dokumen Sertifikat</div>
...
<div class="login-footer">
    ...
    <span class="version-badge">Portal Sertifikasi</span>
</div>
...
(function () {
    ...
    function redirectTo(url) {
        var target = url || '{{ route('certificates.portal.index') }}';
    ...
    function handleResult(result) {
        if (result && result.success) {
            ...
            var targetUrl = result.redirect || '{{ route('certificates.portal.index') }}';
            setTimeout(function () {
    ...
    if (togglePw) {
        togglePw.addEventListener('click', function (e) {
            e.stopPropagation();
            var pwInput = document.getElementById('certLoginPassword');
    ...
    document.getElementById('loginForm').addEventListener('submit', function (e) {
        ...
        var identifier = String(document.getElementById('certLoginIdentifier').value || '').trim();
        var password   = String(document.getElementById('certLoginPassword').value || '');

        if (!identifier) { document.getElementById('certLoginIdentifier').focus(); showError('Email atau Username wajib diisi.'); return; }
        if (!password)   { document.getElementById('certLoginPassword').focus();   showError('Password wajib diisi.');           return; }
        ...
        fetch('{{ route('certificates.login.post') }}', {
            method: 'POST',
