  ...
  <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content" style="border-radius:16px">
      ...
      <div class="modal-body p-4">
        ...
        <div class="p-3 rounded-3 mb-4" id="efPreviewBanner" style="background:#f0f7ff;border:1px solid #c7dff7;display:none">
          <div class="d-flex align-items-center gap-3">
            <div style="width:44px;height:44px;font-size:16px;flex-shrink:0;background:#0B2540;color:#fff;border-radius:12px;display:flex;align-items:center;justify-content:center;font-weight:800" id="efBannerAvatar">?</div>
        ...
        {{-- ============================================================
             ...
             ============================================================ --}}
        <div class="mb-3">
          <p class="fw-bold mb-3" style="font-size:12px;text-transform:uppercase;letter-spacing:.05em;color:#0B2540">
            <i class="bi bi-person-badge-fill me-1"></i>Identitas &amp; Data Pribadi
          </p>
          <div class="row g-2">
            <div class="col-md-6">
              <label class="form-label fw-semibold" style="font-size:12.5px">Nama Lengkap <span class="text-danger">*</span></label>
              <input type="text" class="form-control form-control-sm" id="efName" placeholder="Nama lengkap sesuai KTP" required />
            </div>
            <div class="col-md-3">
              <label class="form-label fw-semibold" style="font-size:12.5px">NIK (16 Digit)</label>
              <input type="text" class="form-control form-control-sm" id="efNik" maxlength="16" placeholder="16 digit NIK" />
            </div>
            <div class="col-md-3">
              <label class="form-label fw-semibold" style="font-size:12.5px">NPWP (16 Digit)</label>
              <input type="text" class="form-control form-control-sm" id="efNpwp" maxlength="16" placeholder="16 digit NPWP" />
            </div>
            <div class="col-md-4">
              <label class="form-label fw-semibold" style="font-size:12.5px">Tempat Lahir</label>
              <input type="text" class="form-control form-control-sm" id="efBirthPlace" placeholder="Kota tempat lahir" />
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
              ...
              <input type="email" class="form-control form-control-sm" id="efEmail" placeholder="email@domain.com" />
            </div>
            <div class="col-md-4">
              <label class="form-label fw-semibold" style="font-size:12.5px">No. HP</label>
              <input type="text" class="form-control form-control-sm" id="efPhone" placeholder="628xxxxxxxxxx" />
            </div>
            <div class="col-12">
            ...
            <div class="col-12">
              ...
              <textarea class="form-control form-control-sm" id="efResidentialAddress" rows="2" placeholder="Alamat domisili (kosongkan jika sama dengan KTP)"></textarea>
            </div>
          </div>
        </div>
        ...
        <div class="mb-3">
          ...
          <div class="row g-2">
            <div class="col-md-4">
              ...
              <input type="email" class="form-control form-control-sm" id="efWorkingEmail" placeholder="email@perusahaan.com" />
            </div>
            <div class="col-md-4">
              <label class="form-label fw-semibold" style="font-size:12.5px">Nama Bank</label>
              <input type="text" class="form-control form-control-sm" id="efBankName" value="BCA" readonly style="background:#f8f9fa" />
            </div>
            <div class="col-md-4">
              <label class="form-label fw-semibold" style="font-size:12.5px">Nomor Rekening</label>
              <input type="text" class="form-control form-control-sm" id="efBankAccount" placeholder="Nomor rekening bank" />
            </div>
            <div class="col-md-4">
              <label class="form-label fw-semibold" style="font-size:12.5px">Atas Nama Rekening</label>
              <input type="text" class="form-control form-control-sm" id="efBankHolder" placeholder="Nama pemilik rekening" />
            </div>
            <div class="col-md-4">
              <label class="form-label fw-semibold" style="font-size:12.5px">BPJS Ketenagakerjaan</label>
              <input type="text" class="form-control form-control-sm" id="efBpjsTk" placeholder="Nomor BPJS Ketenagakerjaan" />
            </div>
            <div class="col-md-4">
              <label class="form-label fw-semibold" style="font-size:12.5px">BPJS Kesehatan</label>
              <input type="text" class="form-control form-control-sm" id="efBpjsKes" placeholder="Nomor BPJS Kesehatan" />
            </div>
          </div>
        </div>
        ...
        <div class="mb-3">
          ...
          <div class="row g-2">
            ...
            <div class="col-md-4">
              ...
              <input type="text" class="form-control form-control-sm" id="efBranch" placeholder="Nama entitas perusahaan" />
            </div>
            <div class="col-md-4">
              <label class="form-label fw-semibold" style="font-size:12.5px">Divisi</label>
              <input type="text" class="form-control form-control-sm" id="efDivision" placeholder="Nama divisi" />
            </div>
            <div class="col-md-4">
              <label class="form-label fw-semibold" style="font-size:12.5px">Departemen</label>
              <input type="text" class="form-control form-control-sm" id="efDept" placeholder="Nama departemen" />
            </div>
            <div class="col-md-4">
              <label class="form-label fw-semibold" style="font-size:12.5px">Cost Center</label>
              <input type="text" class="form-control form-control-sm" id="efCostCenter" placeholder="Kode cost center" />
            </div>
            <div class="col-md-4">
              <label class="form-label fw-semibold" style="font-size:12.5px">Jabatan (dengan Lokasi)</label>
              <input type="text" class="form-control form-control-sm" id="efPos" placeholder="Jabatan + lokasi" />
            </div>
            <div class="col-md-4">
              <label class="form-label fw-semibold" style="font-size:12.5px">Jabatan (tanpa Lokasi)</label>
              <input type="text" class="form-control form-control-sm" id="efPosNoLoc" placeholder="Jabatan tanpa lokasi" />
            </div>
            <div class="col-md-4">
              <label class="form-label fw-semibold" style="font-size:12.5px">Job Level</label>
              <input type="text" class="form-control form-control-sm" id="efJobLevel" placeholder="Staff / Supervisor / Manager..." />
            </div>
            <div class="col-md-4">
              <label class="form-label fw-semibold" style="font-size:12.5px">Grade</label>
              <input type="text" class="form-control form-control-sm" id="efGrade" placeholder="Grade / Level" />
            </div>
            <div class="col-md-4">
              <label class="form-label fw-semibold" style="font-size:12.5px">Area Kerja (Kecamatan)</label>
              <input type="text" class="form-control form-control-sm" id="efDistrict" placeholder="Area kerja" />
            </div>
            <div class="col-md-4">
              <label class="form-label fw-semibold" style="font-size:12.5px">Lokasi Kerja (Kota)</label>
              <input type="text" class="form-control form-control-sm" id="efCity" placeholder="Kota lokasi kerja" />
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control form-control-sm" id="efDirectSup" placeholder="Nama atasan langsung" />
            </div>
            <div class="col-md-6">
              <label class="form-label fw-semibold" style="font-size:12.5px">Atasan Tidak Langsung</label>
              <input type="text" class="form-control form-control-sm" id="efIndirectSup" placeholder="Nama atasan tidak langsung" />
            </div>
            <div class="col-md-6">
              <label class="form-label fw-semibold" style="font-size:12.5px">Vendor Outsource</label>
              <input type="text" class="form-control form-control-sm" id="efOutsourceVendor" placeholder="Nama vendor (jika outsource)" />
            </div>
          </div>
        </div>
        ...
        <div class="mb-3">
          ...
          <div class="row g-2">
            <div class="col-md-4">
              <label class="form-label fw-semibold" style="font-size:12.5px">Tanggal Mulai Kontrak</label>
              <input type="date" class="form-control form-control-sm" id="efContractStart" />
            </div>
            <div class="col-md-4">
              <label class="form-label fw-semibold" style="font-size:12.5px">Tanggal Akhir Kontrak</label>
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control form-control-sm" id="efContractNumber" placeholder="Nomor kontrak PKWT" />
            </div>
          </div>
        </div>
        ...
        <div class="mb-3">
          ...
          <div class="alert alert-info d-flex align-items-center gap-2 py-2 px-3 mb-3" id="efNoMutasiInfo" style="font-size:12px;border-radius:8px">
            <i class="bi bi-info-circle-fill"></i>
            <span>Field Jabatan Sebelumnya, Tipe Rotasi, dan Nomor SK hanya diisi jika karyawan pernah dimutasi/rotasi. Gunakan modal <strong>Rotasi</strong> untuk memproses rotasi baru.</span>
          </div>
          <div class="row g-2">
            <div class="col-md-6">
              <label class="form-label fw-semibold" style="font-size:12.5px">Jabatan Sebelumnya</label>
              <input type="text" class="form-control form-control-sm" id="efFormerPos" placeholder="Jabatan sebelum mutasi" />
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
              <label class="form-label fw-semibold" style="font-size:12.5px">Tanggal Efektif Mutasi</label>
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control form-control-sm" id="efNoSk" placeholder="Nomor SK / surat keputusan" />
            </div>
            <div class="col-md-3" id="efResignDateWrap" style="display:none">
              <label class="form-label fw-semibold" style="font-size:12.5px">Tanggal Resign / Akhir Kerja</label>
        ...
        <div class="mb-1">
          ...
          <div class="row g-2">
            <div class="col-12">
              ...
              <textarea class="form-control form-control-sm" id="efHrNotes" rows="3" placeholder="Catatan internal tim HR..."></textarea>
            </div>
            <div class="col-12">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-sm text-white fw-semibold" style="background:#0B2540" id="btnEmpSave">
