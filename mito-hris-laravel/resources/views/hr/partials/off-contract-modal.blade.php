            ...
            <form action="" method="POST" id="formOffContract">
                    ...
                    <div id="ocEmpPreview" style="display:none">
                        <div class="p-3 rounded-3 mb-4" style="border:1px solid #eb1c24">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div class="text-end flex-shrink-0" style="font-size:11.5px">
                                    ...
                                    <div class="fw-semibold text-primary" id="ocEmpIdDisp">-</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="ocFormSection">
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-12">
                                    <label class="form-label fw-semibold" style="font-size:13px">Tanggal Berakhir
                                        Kontrak <span class="text-danger">*</span></label>
                                    <input type="date" class="form-control form-control-sm" name="last_working_date"
                                        id="ocLastWorkingDate" required />
                                    <div class="form-text" style="font-size:11px">Otomatis dari data kontrak, dapat
                                        disesuaikan</div>
                                </div>
                                <div class="col-12">
                                    <label class="form-label fw-semibold" style="font-size:13px">Catatan <span
                                            class="text-muted fw-normal">(opsional)</span></label>
                                    <textarea class="form-control form-control-sm" name="notes" id="ocNotes" rows="2"
                                        placeholder="Misal: Kontrak berakhir dan tidak diperpanjang atas pertimbangan kebutuhan tim..."></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="bpjs_tk"
                                        id="ocBpjsTk" placeholder="Untuk proses klaim JHT" />
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold" style="font-size:13px">No. BPJS
                                        Kesehatan</label>
                                    <input type="text" class="form-control form-control-sm" name="bpjs_kes"
                                        id="ocBpjsKes" placeholder="Untuk proses nonaktivasi" />
                                </div>
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="approved_by"
                                        id="ocApprovedBy" value="Human Resources Department" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-sm text-white fw-semibold" style="background:#eb1c24"
                        id="btnConfirmOffContract" disabled>
...
<script>
    ...
    function handleOcEmpSearch(query) {
        ...
        if (matched.length === 0) {
            dropdown.innerHTML =
                '<div class="p-3 text-muted text-center" style="font-size:13px">Tidak ada karyawan kontrak yang cocok</div>';
            dropdown.style.display = 'block';
            return;
        }

        dropdown.innerHTML = matched.map(function(emp) {
            return '<div class="p-2 border-bottom d-flex align-items-center gap-2 hover-item oc-search-item" style="cursor:pointer;" data-emp-id="' +
                (emp.employeeId || '') + '">' +
        ...
        dropdown.querySelectorAll('.oc-search-item').forEach(function(item) {
            item.addEventListener('click', function() {
                ...
                var found = (window.__contractEmployeesForOff || []).find(function(e) {
